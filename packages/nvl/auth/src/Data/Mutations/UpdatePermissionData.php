...
final class UpdatePermissionData extends Data
{
    ...
    /**
     * Validate and create a permission mutation with server-resolved update context.
     *
     * @param  array<string, mixed>  $payload
     */
    public static function validateForUpdate(array $payload, string $permissionId): self
    {
    ...
    public static function rules(?ValidationContext $context = null): array
    {
        ...
        return [
            'name' => [
                ...
                'string',
                'max:160',
                Rule::unique($permissions, 'name')->where('guard_name', $guard)->ignore($permissionId),
            ],

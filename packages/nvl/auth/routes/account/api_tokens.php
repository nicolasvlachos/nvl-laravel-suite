...
$tenantAdmission = config('tenancy.enabled') === true
    ? [EnsureAuthTenantAccess::class, RequireTenantMembership::class]
    : [];

Route::middleware($tenantAdmission)->group(function (): void {

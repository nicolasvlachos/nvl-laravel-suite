...
`nvl/support` is the smallest foundation in the NVL package family. It provides transport-neutral business exceptions, stable response-code contracts, and shared package configuration merging for Laravel 13 on PHP 8.4+.

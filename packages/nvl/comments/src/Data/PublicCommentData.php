...
/**
 * Viewer-independent public comment projection with no policy or actor internals.
 */
#[MapInputName(CamelCaseMapper::class)]
#[MapOutputName(CamelCaseMapper::class)]
#[TypeScript]
final class PublicCommentData extends Data
{
    use DataTransform;
    ...
    public function __construct(
        ...
        #[DataCollectionOf(CommentReactionSummaryData::class)]
    ...
    private static function reactionCount(array $reactions): int
    {
        return array_sum(array_map(
            static fn (CommentReactionSummaryData $reaction): int => $reaction->count,
            $reactions,
        ));
    }

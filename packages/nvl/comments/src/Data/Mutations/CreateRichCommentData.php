...
/**
 * Validated contract for creating a rich root comment or reply.
 */
#[MapInputName(CamelCaseMapper::class)]
#[MapOutputName(CamelCaseMapper::class)]
#[TypeScript]
final class CreateRichCommentData extends Data
{
    use DataTransform;

    /**
     * Create one rich comment mutation contract.
     *
    ...
    /**
     * Return the rich creation request validation contract.
     *
